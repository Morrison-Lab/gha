...
| `plugin-marketplaces`    | string  | `''`                        | Newline-separated Claude Code plugin marketplace Git URLs (e.g. `https://github.com/d-morrison/ai-config.git`). Pair with `plugins` below; empty to disable.                                                                                                                                                                         |
| `plugins`                | string  | `''`                        | Newline-separated plugin refs to install (`<plugin>@<marketplace-name>`, e.g. `ai-config@d-morrison`). Each marketplace name must match one listed in `plugin-marketplaces`.                                                                                                                                                         |
...
jobs:
  claude:
    ...
    #   plugin-marketplaces: https://github.com/d-morrison/ai-config.git
