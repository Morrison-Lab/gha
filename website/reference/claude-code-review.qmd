...
| `report-cost` | boolean | `true` | Post a follow-up PR comment with the review's dollar cost (`total_cost_usd`, summed across the initial attempt and any stub-review retry). The action itself only writes this to the job step summary, never a comment. Set false to suppress it. |
