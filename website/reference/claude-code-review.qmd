...
| `use-ai-config`       | boolean | `true`                  | Install the [`Morrison-Lab/ai-config`](https://github.com/Morrison-Lab/ai-config) plugin (`ai-config@d-morrison`) alongside the built-in `code-review@claude-code-plugins`, so the reviewer applies the lab's shared review conventions rather than only the calling repo's own `CLAUDE.md`. Set false to opt out.                                                                                                                                                                            |
