...
The gate skips gray in four cases:

- the PR is a draft, a fork PR, or authored by a bot, so `claude-review` never
  ran;
- the API quota was exhausted before any review work happened;
- a dispatched review was blocked by the fork/Dependabot dispatch guard;
...
this workflow at all, and the condition is **permanent for that PR** --- no
push and no re-dispatch will clear it. The review job posts a PR comment saying
so. Merge such a PR on a self-review or a human review; do not read the gray
gate as an all-clear.
