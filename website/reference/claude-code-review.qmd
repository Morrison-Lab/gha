...
| `plugin-marketplaces` | string  | `''`                    | Extra newline-separated plugin marketplace Git URLs, appended to the built-in `anthropics/claude-code.git` marketplace the `code-review` plugin ships from (e.g. `https://github.com/d-morrison/ai-config.git`). Pair with `plugins` below; empty to disable.                                                                                                                                                                                                                              |
| `plugins`             | string  | `''`                    | Extra newline-separated plugin refs to install (`<plugin>@<marketplace-name>`, e.g. `ai-config@d-morrison`), appended to the built-in `code-review@claude-code-plugins`. Each marketplace name must match one listed in `plugin-marketplaces`.                                                                                                                                                                                                                                             |
