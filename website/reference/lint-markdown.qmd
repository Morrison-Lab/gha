...
Lint tracked Markdown files with [`markdownlint-cli2`](https://github.com/DavidAnson/markdownlint-cli2) using a bundled default config (overridable), plus a companion check that flags fenced code blocks longer than a configurable line threshold as decomposition candidates.
...
jobs:
  lint:
    uses: d-morrison/gha/.github/workflows/lint-markdown.yml@v2
    # with:
...
See [`examples/lint-markdown.yml`](https://github.com/d-morrison/gha/blob/main/examples/lint-markdown.yml)
