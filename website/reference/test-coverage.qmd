...
That job does not upload to Codecov, emit an artifact, or apply `min-coverage`.
The percent appears in the job log and the step summary only,
and the job fails only when examples or vignettes error.
