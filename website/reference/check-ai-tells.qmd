...
signposting filler), computing tell density per 1,000 words.

The catalog is the mechanical subset of the prose rules in
[*Principles of Scientific Writing*](https://morrison-lab.github.io/psw/chapters/avoid-ai-tells.html),
which is the canonical list.
Add a tell there first, then add a pattern here when a regex can find it.
