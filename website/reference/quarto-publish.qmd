...
The example stub used to name that group, from before the job-level one
existed; it now names `quarto-publish-${{ github.ref }}` instead, keeping
the serialization without the collision.
