...
R package repos can use `scripts/assemble-news.sh` at release time to collate
`news.d/` fragments into `NEWS.md` under standard headings (`## New features`,
`## Bug fixes`, `## Minor improvements`, `## Breaking changes`).
