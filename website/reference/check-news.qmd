...
R package repos can use the [`assemble-news`](assemble-news.qmd)
...
(the live-label read behind the skip-label exemption;
GitHub checks a PR's label read against the pull-requests permission).
A caller with no explicit `permissions:` block needs nothing;
