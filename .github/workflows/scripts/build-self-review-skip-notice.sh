...
# can be unit-tested offline (gha#441).
#
# Usage: build-self-review-skip-notice.sh <workflow-path> <run-url>
# Prints the formatted markdown notice to stdout.
set -euo pipefail

WF_PATH="${1:?usage: build-self-review-skip-notice.sh <workflow-path> <run-url>}"
