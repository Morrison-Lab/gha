...
- [ ] Task: Write failing test (Red Phase)
  - [ ] Identify how the sidecar script is tested in this repository.
  - [ ] Write a test case that triggers a denied-tools violation and specifically checks for proper heredoc termination (e.g., a trailing newline).
