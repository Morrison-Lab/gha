- Audited central workflows (`claude.yml`, `claude-code-review.yml`,
  ...
  v1.0.2, and the `google-antigravity` Python SDK runner actions), confirming
  alignment on permissions, inputs, trusted-author gates, and PR execution
  parity ([#483](https://github.com/Morrison-Lab/gha/issues/483)).
