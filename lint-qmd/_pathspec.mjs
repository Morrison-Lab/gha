// Shared glob-based path-ignore matching for lint-qmd. Kept local to this
// composite (not imported across composite directories) so each capability
// in this repo stays independently taggable and self-contained; mirrors
// lint-markdown/_pathspec.mjs's logic for consistency across both linters.
