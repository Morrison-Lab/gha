...
as `cursor[bot]` should be able to post `/review` -- App comments usually have
`author_association: NONE`). It's a slash command rather than an `@claude review` mention on
