...
Find them with the UNSCOPED, per-workflow code search that
...
Measured 2026-09-07, the owner list as it stood before 2026-09-06 returned
10 of the 18 repositories pinning `claude-code-review.yml@v2`, missing all 8
under owners nobody had added yet.
The list has since been corrected and now returns all 18 --- which is the
point: it was wrong for as long as nobody looked.
