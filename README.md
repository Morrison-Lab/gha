...
| `spellcheck.yml` | Spellcheck an R package's prose (DESCRIPTION, `.Rd`, vignettes, `NEWS.md`) with {spelling}, accepting the package's own `inst/WORDLIST` | `path`, `exclude`, `additional-options`, `install-quarto` |
